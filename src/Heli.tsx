...
export const Heli: React.VFC<SVGProps<SVGSVGElement>> = (props) => (
  <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="helicopter" className="svg-inline--fa fa-helicopter fa-w-20" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" {...props}>
